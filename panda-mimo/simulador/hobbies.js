...
const I=(id,forma,x,y,mm,rotacao=0)=>({id,tipo:'enfeite',forma,rotulo:forma.replace(/^(hobby|atelie|data|convite)-/,'').replaceAll('-',' '),x,y,tamanho:mm/90,rotacao,cor:desenhos[forma].primary});
